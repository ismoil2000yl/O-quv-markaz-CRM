    ...
    const deleteConfirm = (id) => {
        deletedHandler({
            ...
            onSuccess: () => {
                messageApi.open({
                    type: 'success',
                    content: "Direktor o'chirib yuborildi"
                }),
                    navigate("/xodimlar/direktor"),
                    getData()
            },
            onError: () => {
                messageApi.open({
                    type: 'error',
                    content: "Direktor o'chirilmadi!"
                })
            }
        })
    };
                    ...
                    >
                        ...
                        <div className='w-full mt-8 flex items-start md:items-center flex-col md:flex-row justify-start gap-6'>
                            ...
                            <div className='w-[120px] h-[120px] bg-white p-1 flex items-center justify-center rounded-[50%]'>
                                <img src={data?.user_image ? data?.user_image : IconUser} className='w-full h-full object-contain rounded-[50%]' alt="" />
                            </div>
